export const STATUS_COLORS = {
  "New Lead": { color: "#3b82f6", bg: "rgba(59,130,246,0.10)", border: "rgba(59,130,246,0.20)", label: "New Lead", dot: "#3b82f6" },
  "Survey Needed": { color: "#f59e0b", bg: "rgba(245,158,11,0.10)", border: "rgba(245,158,11,0.20)", label: "Survey", dot: "#f59e0b" },
  "Survey Complete": { color: "#d97706", bg: "rgba(217,119,6,0.10)", border: "rgba(217,119,6,0.20)", label: "Survey Done", dot: "#d97706" },
  "Ready For AI Quote": { color: "#D4AF37", bg: "rgba(212,175,55,0.10)", border: "rgba(212,175,55,0.20)", label: "AI Quote", dot: "#D4AF37" },
  "Quote Drafted": { color: "#D4AF37", bg: "rgba(212,175,55,0.10)", border: "rgba(212,175,55,0.20)", label: "Quoting", dot: "#D4AF37" },
  "Ready To Send": { color: "#b8960c", bg: "rgba(184,150,12,0.10)", border: "rgba(184,150,12,0.20)", label: "Ready", dot: "#b8960c" },
  "Quote Sent": { color: "#8b5cf6", bg: "rgba(139,92,246,0.10)", border: "rgba(139,92,246,0.20)", label: "Sent", dot: "#8b5cf6" },
